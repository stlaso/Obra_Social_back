        ...
        return [
            ...
            'documentaciones' => $this->when('documentaciones', function () {
                return $this->documentaciones->map(function ($doc) {
                    // Verificar si 'url_archivo' ya está definido, si no, generar la URL
                    $urlArchivo = $doc->url_archivo ?? ($doc->archivo ? Storage::url($doc->archivo) : null);

                    // Asignar la URL generada a 'url_archivo'
                    $doc->url_archivo = $urlArchivo;
